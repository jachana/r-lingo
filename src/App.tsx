...
const lessons: Lesson[] = [
  ...
  },
  {
    ...
    challenges: [
      ...
      {
        prompt: 'Qué operador sirve para buscar varias comunas posibles?',
  ...
  },
  {
    ...
    challenges: [
      ...
      {
        prompt: 'Qué estética suele ir en el eje x de una curva epidémica?',
...
const lessonSupport: Record<string, LessonSupport> = {
  'Primeros pasos en R': {
    keyIdeas: [
...
const extraChallenges: Record<string, Challenge[]> = {
  'Primeros pasos en R': [
    {
...
function getLessonChallenges(lesson: Lesson) {
